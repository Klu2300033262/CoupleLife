    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40">
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none opacity-20">
            {[...Array(5)].map((_, i) => (
              <motion.div
                ...
                className="absolute bottom-0 left-1/2 text-primary"
              >
          ...
          <h2 className="text-2xl font-bold text-dark mb-2">Connected Forever 💖</h2>
          ...
          <button
            onClick={onClose}
            className="w-full bg-primary text-white py-3 rounded-lg font-medium hover:bg-primary-light transition-colors relative z-10"
          >
            Continue
          </button>
        </motion.div>
